...
export function createDatabasePool({ databaseUrl = "", databaseSsl = "", databaseSslRejectUnauthorized = "" } = {}) {
  ...
  return new Pool({
    connectionString,
    ssl: useSsl(databaseSsl) ? { rejectUnauthorized: verifyCertificate(databaseSslRejectUnauthorized) } : undefined,
  });
}
